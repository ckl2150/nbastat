...
%            t.Visible='on';
            ...
            pb3=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
               'Position', [.25 .683 .05 .071],'Callback', @pbfun3);
            pb4=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
                'Position', [.25 .612 .05 .07],'Callback', @pbfun4);
            pb5=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
                'Position', [.25 .541 .05 .071],'Callback', @pbfun5);
            pb6=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
                'Position', [.25 .47 .05 .07],'Callback', @pbfun6);
            pb7=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
                'Position', [.25 .4 .05 .07],'Callback', @pbfun7);
            pb8=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
                'Position', [.25 .33 .05 .07],'Callback', @pbfun8);
            pb9=uicontrol(singleplayerfig,'Style','pushbutton','String','Plot Stat','Units','normalized',...
